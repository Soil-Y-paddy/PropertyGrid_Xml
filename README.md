...
* 目次
    * [ プロパティグリッドの拡張 ](#c1)
        * [共通事項](#s1)
        * [ [ファイルを開く]ダイアログを表示させるプロパティエディタと追加属性 ](#s2)
        * [  [フォルダの参照]ダイアログを表示させるプロパティエディタ ](#s3)
        * [ コンボボックスをプロパティに設定する汎用コンバータと追加属性 ](#s4)
        * [ インターフェイスをジェネリックにしたコレクションのためのコレクションエディタ ](#s5)
        * [ プロパティ値を設定するユーザダイアログを表示するプロパティエディタと追加属性 ](#s6)
        * [ プロパティ値を設定するコントロールをインライン(ドロップダウン)表示するプロパティエディタと追加属性 ](#s7)
...
## <a id="s2"> [ファイルを開く]ダイアログを表示させるプロパティエディタと追加属性 </a>
<dl>
<dt>エディタ</dt>
...
## <a id="s3"> [フォルダの参照]ダイアログを表示させるプロパティエディタ </a>
<dl>
<dt>エディタ</dt>
...
## <a id="s4"> コンボボックスをプロパティに設定する汎用コンバータと追加属性 </a>
<dl>
<dt>タイプコンバータ</dt>
...
## <a id="s5">インターフェイスをジェネリックにしたコレクションのためのコレクションエディタ</a>
...
## <a id="s6"> プロパティ値を設定するユーザダイアログを表示するプロパティエディタと追加属性 </a>
...
## <a id="s7">プロパティ値を設定するコントロールをインライン(ドロップダウン)表示するプロパティエディタと追加属性</a>
